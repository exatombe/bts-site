                    ...
                    >
                       ...
                       // check User profile picture and display it or default picture
                          if (isset($_SESSION['user'])) {
                                ...
                                $picture = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/media/users/user-' . $id . '.jpg') ?  '/media/users/user-' . $id . '.jpg' : (file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/media/users/user-' . $id . '.png') ?  '/media/users/user-' . $id . '.png' : (file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/media/users/user-' . $id . '.jpeg') ? '/media/users/user-' . $id . '.jpeg' : false));
                            if($picture){
                       ?>
                            <img style="width: 60px; heigth:60px;" src="<?= $picture ?>" alt="profile picture" />
                          <?php
                            }else{
                            ?>
                       <path
...
<div class="container">
  <div class="shopping-cart" style="display: none;">
    ...
    <i class="fa fa-shopping-cart cart-icon"></i><span class="badge"><?= $session->getCartQuantity(); ?></span>
