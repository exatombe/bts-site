...
include './src/repository/mangaRepository.php';
include './src/repository/avisRepository.php';
include './src/repository/commandeRepository.php';
include './src/repository/artisteRepository.php';
include './src/repository/auteurRepository.php';
include './src/repository/detailCommandeRepository.php';
